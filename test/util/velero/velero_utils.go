...
var ImagesMatrix = map[string]map[string][]string{
	...
	"v1.16": {
		"aws":                   {"gcr.io/velero-gcp/velero-plugin-for-aws:v1.12.0-rc.1"},
		"azure":                 {"gcr.io/velero-gcp/velero-plugin-for-microsoft-azure:v1.12.0-rc.1"},
		"vsphere":               {"gcr.io/velero-gcp/velero-plugin-for-vsphere:v1.5.2"},
		"gcp":                   {"gcr.io/velero-gcp/velero-plugin-for-gcp:v1.12.0-rc.1"},
		"datamover":             {"gcr.io/velero-gcp/velero-plugin-for-aws:v1.12.0-rc.1"},
		"velero":                {"gcr.io/velero-gcp/velero:release-1.16-dev"},
		"velero-restore-helper": {"gcr.io/velero-gcp/velero:release-1.16-dev"},
	},
	"main": {
