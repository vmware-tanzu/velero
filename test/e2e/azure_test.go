...
var _ = Describe("[Azure] [Kind] Velero tests on Kind cluster using Azure provider for object storage", func() {
	var (
	...
	BeforeEach(func() {
		...
		io, err := GetProviderVeleroInstallOptions("azure", cloudCredentialsFile)
