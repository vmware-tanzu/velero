...
func (s *PVCSelectedNodeChanging) Init() error {
	...
	s.labels = map[string]string{"velero.io/plugin-config": "",
		"velero.io/change-pvc-node-selector": "RestoreItemAction"}
	s.configmaptName = "change-pvc-node-selector-config"
	s.volume = "volume-1"
	s.podName = "pod-1"
	return nil
}

func (s *PVCSelectedNodeChanging) StartRun() error {
...
func (s *PVCSelectedNodeChanging) CreateResources() error {
	...
	oldPodName := GetPodNodeName(s.Ctx, s.Client, s.namespace, s.podName)
...
func (s *PVCSelectedNodeChanging) Destroy() error {
...
func (s *PVCSelectedNodeChanging) Restore() error {
...
func (s *PVCSelectedNodeChanging) Verify() error {
