---
layout: docs
title: velero client config get
---
Get client configuration file values

```
velero client config get [KEY 1] [KEY 2] [...] [flags]
```
...
* [velero client config](velero_client_config.md)	 - Get and set client configuration file values
