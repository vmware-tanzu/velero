---
layout: docs
title: velero backup-location delete
---
Delete backup storage locations

```
velero backup-location delete [NAMES] [flags]
```

### Examples

```
  # Delete a backup storage location named "backup-location-1".
...
```
      --all                      Delete all backup-locations
      --confirm                  Confirm deletion
  -h, --help                     help for delete
  -l, --selector labelSelector   Delete all backup-locations matching this label selector. (default <none>)
```
