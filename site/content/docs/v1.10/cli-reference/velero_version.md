---
layout: docs
title: velero version
---
Print the velero version and associated image

```
velero version [flags]
```

### Options

```
      --client-only        Only get velero client version, not server version
  -h, --help               help for version
      --timeout duration   Maximum time to wait for server version to be reported. Default is 5 seconds. (default 5s)
```
