---
layout: docs
title: velero schedule unpause
---
Unpause schedules

```
velero schedule unpause [flags]
```

### Examples

```
  # Unpause a schedule named "schedule-1".
...
```
      --all                      Pause all schedules
  -h, --help                     help for unpause
  -l, --selector labelSelector   Pause all schedules matching this label selector. (default <none>)
```
