---
layout: docs
title: velero backup describe
---
Describe backups

```
velero backup describe [NAME1] [NAME2] [NAME...] [flags]
```
...
```
  ...
  -o, --output string              Output display format. Valid formats are 'plaintext, json'. 'json' only applies to a single backup (default "plaintext")
