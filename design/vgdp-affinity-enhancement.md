...
* If the `LoadAffinity` element's `StorageClass` has value, it means this element is applied to the VGDP instances use specified StorageClass.
...
flowchart TD
    ...
    K --> M{Check final StorageClass in loadAffinity by StorageClass filed}
    L --> I
    
    I -->|StorageClass found| N[Apply loadAffinity<br/>for this StorageClass<br/>🎯 HIGHEST PRIORITY]
