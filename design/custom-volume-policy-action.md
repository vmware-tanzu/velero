...
different plugins that implement custom actions, the plugin will be
responsible for looking at the returned action parameters map if the
action is custom. For example, there might be a custom BIA that's
