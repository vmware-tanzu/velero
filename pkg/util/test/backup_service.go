...
func (_m *BackupService) BackupExists(bucket string, backupName string) (bool, error) {
...
// CreateSignedURL provides a mock function with given fields: target, bucket, directory, ttl
func (_m *BackupService) CreateSignedURL(target v1.DownloadTarget, bucket string, directory string, ttl time.Duration) (string, error) {
