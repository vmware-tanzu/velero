...
const (
	...
	DownloadTargetKindCSIVolumeSnapshots        DownloadTargetKind = "CSIVolumeSnapshots"
	DownloadTargetKindCSIVolumeSnapshotContents DownloadTargetKind = "CSIVolumeSnapshotContents"
)
