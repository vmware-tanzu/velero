...
func NewServiceAction(logger logrus.FieldLogger) actioninterface.RestoreItemAction {
	return &serviceAction{log: logger}
}

func (a *serviceAction) AppliesTo() (actioninterface.ResourceSelector, error) {
