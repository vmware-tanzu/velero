...
func (_m *RestoreItemAction) AppliesTo() (actioninterface.ResourceSelector, error) {
	ret := _m.Called()
...
func (_m *RestoreItemAction) Execute(obj runtime.Unstructured, _a1 *v1.Restore) (runtime.Unstructured, error, error) {
