...
func NewResticRestoreAction(logger logrus.FieldLogger) actioninterface.RestoreItemAction {
...
func (a *resticRestoreAction) AppliesTo() (actioninterface.ResourceSelector, error) {
