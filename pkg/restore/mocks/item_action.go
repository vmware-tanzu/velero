...
import (
	restore "github.com/heptio/ark/pkg/restore"
...
func (_m *ItemAction) Execute(obj kube.UnstructuredObject, _a1 *v1.Restore) (kube.UnstructuredObject, error, error) {
	ret := _m.Called(obj, _a1)

	var r0 kube.UnstructuredObject
	if rf, ok := ret.Get(0).(func(kube.UnstructuredObject, *v1.Restore) kube.UnstructuredObject); ok {
		r0 = rf(obj, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(kube.UnstructuredObject, *v1.Restore) error); ok {
		r1 = rf(obj, _a1)
	} else {
		r1 = ret.Error(1)
	}
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(kube.UnstructuredObject, *v1.Restore) error); ok {
		r2 = rf(obj, _a1)
	} else {
		r2 = ret.Error(2)
	}
