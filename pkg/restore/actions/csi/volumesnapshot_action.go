...
func (p *volumeSnapshotRestoreItemAction) Execute(
	...
	generatedName := generateSha256FromRestoreAndVsUID(string(input.Restore.UID), string(vsFromBackup.UID))
...
func NewVolumeSnapshotRestoreItemAction(
	...
	return func(logger logrus.FieldLogger) (any, error) {
		...
		return &volumeSnapshotRestoreItemAction{logger, crClient, resourceTimeout}, nil
	}
}
