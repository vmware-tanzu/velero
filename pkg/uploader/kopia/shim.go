...
func (sr *shimRepository) VerifyObject(_ context.Context, _ object.ID) ([]content.ID, error) {
...
func (sr *shimRepository) Refresh(_ context.Context) error {
	return errors.New("Refresh is not supported")
}

// ContentInfo not supported
func (sr *shimRepository) ContentInfo(_ context.Context, _ content.ID) (content.Info, error) {
	return index.Info{}, errors.New("ContentInfo is not supported")
}

// PrefetchContents is not supported by unified repo
func (sr *shimRepository) PrefetchContents(_ context.Context, _ []content.ID, _ string) []content.ID {
	return nil
}

// PrefetchObjects is not supported by unified repo
func (sr *shimRepository) PrefetchObjects(_ context.Context, _ []object.ID, _ string) ([]content.ID, error) {
	return nil, errors.New("PrefetchObjects is not supported")
}

// UpdateDescription is not supported by unified repo
func (sr *shimRepository) UpdateDescription(_ string) {
}

// NewWriter is not supported by unified repo
func (sr *shimRepository) NewWriter(_ context.Context, _ repo.WriteSessionOptions) (context.Context, repo.RepositoryWriter, error) {
...
func (sr *shimRepository) OnSuccessfulFlush(_ repo.RepositoryWriterCallback) {
}
