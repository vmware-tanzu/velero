...
func TestFindPreviousSnapshotManifest(t *testing.T) {
	...
	testCases := []struct {
		...
		// No matching snapshots
		{
			...
			listSnapshotsFunc: func(_ context.Context, _ repo.Repository, _ snapshot.SourceInfo) ([]*snapshot.Manifest, error) {
...
func TestRestore(t *testing.T) {
	...
	testCases := []testCase{
		...
		},
		{
			...
			restoreEntryFunc: func(_ context.Context, _ repo.Repository, _ restore.Output, _ fs.Entry, _ restore.Options) (restore.Stats, error) {
