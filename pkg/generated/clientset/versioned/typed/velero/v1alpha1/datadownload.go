...
type DataDownloadInterface interface {
	Create(ctx context.Context, dataDownload *v1alpha1.DataDownload, opts v1.CreateOptions) (*v1alpha1.DataDownload, error)
	Update(ctx context.Context, dataDownload *v1alpha1.DataDownload, opts v1.UpdateOptions) (*v1alpha1.DataDownload, error)
	UpdateStatus(ctx context.Context, dataDownload *v1alpha1.DataDownload, opts v1.UpdateOptions) (*v1alpha1.DataDownload, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.DataDownload, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.DataDownloadList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataDownload, err error)
...
func newDataDownloads(c *VeleroV1alpha1Client, namespace string) *dataDownloads {
...
func (c *dataDownloads) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DataDownload, err error) {
	result = &v1alpha1.DataDownload{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dataDownloads) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DataDownloadList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DataDownloadList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("datadownloads").
...
func (c *dataDownloads) Create(ctx context.Context, dataDownload *v1alpha1.DataDownload, opts v1.CreateOptions) (result *v1alpha1.DataDownload, err error) {
	result = &v1alpha1.DataDownload{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datadownloads").
...
func (c *dataDownloads) Update(ctx context.Context, dataDownload *v1alpha1.DataDownload, opts v1.UpdateOptions) (result *v1alpha1.DataDownload, err error) {
	result = &v1alpha1.DataDownload{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datadownloads").
...
func (c *dataDownloads) UpdateStatus(ctx context.Context, dataDownload *v1alpha1.DataDownload, opts v1.UpdateOptions) (result *v1alpha1.DataDownload, err error) {
	result = &v1alpha1.DataDownload{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datadownloads").
...
func (c *dataDownloads) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DataDownload, err error) {
	result = &v1alpha1.DataDownload{}
