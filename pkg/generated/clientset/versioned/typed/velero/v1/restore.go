...
type RestoreInterface interface {
	...
	Apply(ctx context.Context, restore *velerov1.RestoreApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Restore, err error)
	ApplyStatus(ctx context.Context, restore *velerov1.RestoreApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Restore, err error)
	RestoreExpansion
}
...
func (c *restores) Apply(ctx context.Context, restore *velerov1.RestoreApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Restore, err error) {
	if restore == nil {
...
func (c *restores) ApplyStatus(ctx context.Context, restore *velerov1.RestoreApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Restore, err error) {
	if restore == nil {
		return nil, fmt.Errorf("restore provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
