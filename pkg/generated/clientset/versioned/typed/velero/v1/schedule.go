...
type ScheduleInterface interface {
	...
	Apply(ctx context.Context, schedule *velerov1.ScheduleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Schedule, err error)
	ApplyStatus(ctx context.Context, schedule *velerov1.ScheduleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Schedule, err error)
	ScheduleExpansion
}
...
func (c *schedules) Apply(ctx context.Context, schedule *velerov1.ScheduleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Schedule, err error) {
	if schedule == nil {
...
func (c *schedules) ApplyStatus(ctx context.Context, schedule *velerov1.ScheduleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Schedule, err error) {
	if schedule == nil {
		return nil, fmt.Errorf("schedule provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
