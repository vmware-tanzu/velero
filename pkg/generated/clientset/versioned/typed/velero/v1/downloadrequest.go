...
type DownloadRequestInterface interface {
	...
	Apply(ctx context.Context, downloadRequest *velerov1.DownloadRequestApplyConfiguration, opts metav1.ApplyOptions) (result *v1.DownloadRequest, err error)
	ApplyStatus(ctx context.Context, downloadRequest *velerov1.DownloadRequestApplyConfiguration, opts metav1.ApplyOptions) (result *v1.DownloadRequest, err error)
...
func (c *downloadRequests) Apply(ctx context.Context, downloadRequest *velerov1.DownloadRequestApplyConfiguration, opts metav1.ApplyOptions) (result *v1.DownloadRequest, err error) {
...
func (c *downloadRequests) ApplyStatus(ctx context.Context, downloadRequest *velerov1.DownloadRequestApplyConfiguration, opts metav1.ApplyOptions) (result *v1.DownloadRequest, err error) {
	if downloadRequest == nil {
		return nil, fmt.Errorf("downloadRequest provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
