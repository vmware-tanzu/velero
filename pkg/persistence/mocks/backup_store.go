...
// PutBackupLog provides a mock function with given fields: backup, log
func (_m *BackupStore) PutBackupLog(backup string, log io.Reader) {
	_m.Called(backup, log)
}
...
// PutPostBackupLog provides a mock function with given fields: backup, log
func (_m *BackupStore) PutPostBackupLog(backup string, log io.Reader) {
	_m.Called(backup, log)
}

// PutPostRestoreLog provides a mock function with given fields: backup, restore, log
func (_m *BackupStore) PutPostRestoreLog(backup string, restore string, log io.Reader) {
	_m.Called(backup, restore, log)
}
