...
func (a *serviceAccountAction) AppliesTo() (actioninterface.ResourceSelector, error) {
...
// be backed up.
func (a *serviceAccountAction) Execute(item runtime.Unstructured, backup *v1.Backup) (runtime.Unstructured, []actioninterface.ResourceIdentifier, error) {
