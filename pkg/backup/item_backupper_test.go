...
func TestBackupItemNoSkips(t *testing.T) {
	tests := []struct {
		...
		customActionAdditionalItemIdentifiers []actioninterface.ResourceIdentifier
...
func (b *blockStoreGetter) GetBlockStore(name string) (volumeinterface.BlockStore, error) {
	if b.blockStore != nil {
...
func (a *addAnnotationAction) Execute(item runtime.Unstructured, backup *v1.Backup) (runtime.Unstructured, []actioninterface.ResourceIdentifier, error) {
...
func (a *addAnnotationAction) AppliesTo() (actioninterface.ResourceSelector, error) {
