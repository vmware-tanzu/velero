...
func TestGetCACertFromBackup(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			cacert, err := GetCACertFromBackup(context.Background(), fakeClient, "test-ns", tc.backup)
...
func TestGetCACertFromRestore(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			cacert, err := GetCACertFromRestore(context.Background(), fakeClient, "test-ns", tc.restore)
...
func TestGetCACertFromBSL(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			cacert, err := GetCACertFromBSL(context.Background(), fakeClient, "test-ns", tc.bslName)
...
func TestGetCACertFromBackup_ClientError(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, err := GetCACertFromBSL(context.Background(), fakeClient, "wrong-ns", tc.backup.Spec.StorageLocation)

			assert.NoError(t, err) // Not found errors are handled gracefully
		})
	}
}
...
func TestGetCACertFromRestore_ClientError(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			assert.NoError(t, err) // Not found errors are handled gracefully, returning empty string
