...
func (l *liveBackupGetter) GetAllBackups(bucket string) ([]*api.Backup, error) {
	return GetAllBackups(l.logger, l.objectStore, bucket)
}
...
func NewLiveXXXBackupGetter(logger logrus.FieldLogger, objectStore ObjectStore) XXXBackupGetter {
	return &liveXXXBackupGetter{
		logger:      logger,
		objectStore: objectStore,
	}
}

func (l *liveXXXBackupGetter) GetBackup(bucket, backupName string) (*api.Backup, error) {
