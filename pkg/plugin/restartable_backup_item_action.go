...
// call, the restartableBackupItemAction asks its restartablePluginProcess to restart itself if needed (e.g. if the
...
func newRestartableBackupItemAction(name string, sharedPluginProcess *restartablePluginProcess) *restartableBackupItemAction {
