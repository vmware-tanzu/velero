...
func NewPostRestoreActionPlugin(options ...common.PluginOption) *PostRestoreActionPlugin {
	return &PostRestoreActionPlugin{
		PluginBase: common.NewPluginBase(options...),
	}
}

// GRPCClient returns a PostRestoreAction gRPC client.
func (p *PostRestoreActionPlugin) GRPCClient(_ context.Context, _ *plugin.GRPCBroker, clientConn *grpc.ClientConn) (interface{}, error) {
	return common.NewClientDispenser(p.ClientLogger, clientConn, newPostRestoreActionGRPCClient), nil
}

// GRPCServer registers a PostRestoreAction gRPC server.
