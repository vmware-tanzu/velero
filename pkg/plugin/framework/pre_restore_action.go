...
func NewPreRestoreActionPlugin(options ...common.PluginOption) *PreRestoreActionPlugin {
	return &PreRestoreActionPlugin{
		PluginBase: common.NewPluginBase(options...),
	}
}

// GRPCClient returns a PreRestoreAction gRPC client.
func (p *PreRestoreActionPlugin) GRPCClient(_ context.Context, _ *plugin.GRPCBroker, clientConn *grpc.ClientConn) (interface{}, error) {
	return common.NewClientDispenser(p.ClientLogger, clientConn, newPreRestoreActionGRPCClient), nil
}

// GRPCServer registers a PreRestoreAction gRPC server.
