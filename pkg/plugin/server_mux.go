...
// implements logging.LogSetter, getInstance calls SetLog and passes the plugin process's logger to the instance.
func (m *serverMux) getInstance(name string) (interface{}, error) {
	...
	if logSetter, ok := instance.(logging.LogSetter); ok {
