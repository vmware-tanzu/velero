...
// call, the restartableBlockStore asks its restartablePluginProcess to restart itself if needed (e.g. if the
...
func newRestartableBlockStore(name string, sharedPluginProcess *restartablePluginProcess) *restartableBlockStore {
