...
func (_m *BackupItemAction) Execute(item runtime.Unstructured, backup *v1.Backup) (runtime.Unstructured, []velero.ResourceIdentifier, error) {
...
func (_m *BackupItemAction) Foo() error {
	ret := _m.Called()
