...
func TestClientConfig(t *testing.T) {
	...
	expected := &hcplugin.ClientConfig{
		...
		Plugins: map[string]hcplugin.Plugin{
			...
			string(common.PluginKindPreBackupAction):     framework.NewPreBackupActionPlugin(common.ClientLogger(logger)),
			string(common.PluginKindPostBackupAction):    framework.NewPostBackupActionPlugin(common.ClientLogger(logger)),
			string(common.PluginKindPreRestoreAction):    framework.NewPreRestoreActionPlugin(common.ClientLogger(logger)),
			string(common.PluginKindPostRestoreAction):   framework.NewPostRestoreActionPlugin(common.ClientLogger(logger)),
		},
