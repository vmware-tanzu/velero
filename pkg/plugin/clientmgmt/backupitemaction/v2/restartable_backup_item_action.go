...
func (r *AdaptedV1RestartableBackupItemAction) Progress(_ string, _ *api.Backup) (velero.OperationProgress, error) {
...
func (r *AdaptedV1RestartableBackupItemAction) Cancel(_ string, _ *api.Backup) error {
	return nil
}
