...
func (r *AdaptedV1RestartableBackupItemAction) Progress(string, *api.Backup) (velero.OperationProgress, error) {
...
func (r *AdaptedV1RestartableBackupItemAction) Cancel(string, *api.Backup) error {
	return nil
}
