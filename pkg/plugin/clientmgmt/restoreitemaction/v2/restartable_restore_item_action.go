...
func (r *AdaptedV1RestartableRestoreItemAction) Progress(string, *api.Restore) (velero.OperationProgress, error) {
...
func (r *AdaptedV1RestartableRestoreItemAction) Cancel(string, *api.Restore) error {
	return nil
}

// AreAdditionalItemsReady just returns true since v1 plugins don't wait for items.
func (r *AdaptedV1RestartableRestoreItemAction) AreAdditionalItemsReady([]velero.ResourceIdentifier, *api.Restore) (bool, error) {
	return true, nil
}
