...
// plugin process.
func (r *restartableRestoreItemAction) getRestoreItemAction() (actioninterface.RestoreItemAction, error) {
	plugin, err := r.sharedPluginProcess.getByKindAndName(r.key)
	if err != nil {
		return nil, err
	}

	restoreItemAction, ok := plugin.(actioninterface.RestoreItemAction)
	if !ok {
		return nil, errors.Errorf("%T is not a actioninterface.RestoreItemAction!", plugin)
	}
...
func (r *restartableRestoreItemAction) getDelegate() (actioninterface.RestoreItemAction, error) {
...
func (r *restartableRestoreItemAction) AppliesTo() (actioninterface.ResourceSelector, error) {
